    ...
    <div>
      <div className="hidden fixed lg:flex flex-col items-center justify-center left-6 gap-4 top-0 media-header z-10">
        ...
        <div className="grid gap-2">
          <a href="https://github.com/Jeb4dev" title="GitHub">
      ...
      <div className="px-4 pt-16 pb-6 md:pt-36 md:pb-32 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              <p className="text-base text-white md:text-lg">
                Welcome! I'm Jeb, a software developer with a passion for creating innovative solutions and ensuring
                cybersecurity. Take a look around to learn more about my skills and experience.
              </p>
            </div>
            <div>
              <a href={"#contact"}>
