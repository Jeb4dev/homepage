        ...
        <div className="text-gray-300 md:ml-[-6rem] z-10">
          ...
          <div>
            <p className="pt-8 pb-2">
              Thank you for visiting my website. I hope you enjoyed learning
              more about me and my software skills. If you want to work with me
              or just say hi, feel free to reach out to me. You can find my
              contact details below.
            </p>
            <p className="pt-2 pb-8">
              Whether you want to collaborate on a project, hire me for a
              freelance job, or just chat, I'll try to respond as soon as
