          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 md:mt-0 md:border-0">
            ...
            <li className="hidden">
              <button
                ...
                className="flex items-center justify-between w-full py-2 pl-3 pr-4 text-orange-900 rounded hover:bg-orange-700 md:hover:bg-transparent
              ...
              >
                ...
                >
                  <li>
                    <a
                      href="#"
                      className="block px-4 py-2 hover:bg-orange-500 dark:hover:text-white"
                    >
                      Dashboard
                    </a>
                  </li>
                ...
                <div className="py-1">
                  <a
                    href="#"
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-orange-500 dark:text-gray-400 dark:hover:text-white"
                  >
                    Sign out
                  </a>
                </div>
