export const BlockQuote = () => {
    return (
        ...
        <figure className="max-w-screen-md mx-auto text-center pb-8 md:pb-16">
            <svg aria-hidden="true" className="w-12 h-12 mx-auto mb-3 text-gray-400"
            ...
            <blockquote>
                <p className="text-2xl italic font-medium text-gray-900 dark:text-white">"We are no longer securing computers, we are securing society."</p>
            </blockquote>
