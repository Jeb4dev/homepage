...
export const SkillCard = ({ content }: { content: Content }) => {
    return (<div
            ...
            <div
                className="overflow-hidden w-full h-44 bg-cover bg-center">
                <img
                    src={content.img}
            ...
            <div className="p-4">
                <h4 className="px-2 block text-2xl font-semibold leading-snug tracking-normal text-gray-800 antialiased">
                    {content.skill}
                </h4>
                    ...
                    <button
                        className="relative inline-flex items-center justify-center overflow-hidden
                                ...
                                focus:ring-4 focus:outline-none focus:ring-orange-200 dark:focus:ring-orange-900">
                                  <span
                                      className="font-bold relative px-5 py-1.5 w-full transition-all ease-in duration-75 bg-orange-500 group-hover:bg-opacity-0">
                                      Learn more
                                  </span>
                    </button>
                </a>
