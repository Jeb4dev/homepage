...
export const Contact = () => {
    return (<div id="contact" className="max-w-screen-xl mx-auto p-8 md:px-16">
        ...
        <div className="flex row">
            <div className="hidden md:block">
                <img src="/contactus.png" alt="customer service illustration" className="mx-[-12rem]"/>
                <p className="text-gray-500 text-xs mx-[-6rem] py-2">
                    Illustration designed by <a href="https://www.freepik.com" className="hover:underline">
                    Freepik</a>
                </p>
            </div>
                ...
                <div>
                    <div className="border border-solid">
                        <div className="flex gap-6 px-8 pt-8 pb-3">
                            ...
                            <a href="mailto:contacts@jeb4.dev" className="hover:underline">contacts@jeb4.dev</a>
                        </div>
                        ...
                        <div className="flex gap-6 px-8 py-3 pb-8">
                            <FaDiscord
                                className="w-6 h-6 fill-gray-300"/>
                            <a href="https://discord.com/users/368862359562747916/" target="_blank"
                               className="hover:underline">
                                !Jeb#6466
                            </a>
                        </div>
