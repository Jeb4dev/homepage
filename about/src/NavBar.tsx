                    ...
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 md:mt-0 md:border-0">
                        ...
                        <li className="hidden">
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                                    ...
                                    md:border-0 md:hover:text-orange-700 md:p-0 md:w-auto">Dropdown <svg
                        ...
                        <li>
                            <a href="#projects"
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0">Projects</a>
                        </li>
                        <li>
                            <a href="#skills"
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0">Skills</a>
                        </li>
                        <li>
                            <a href="#about"
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0">About</a>
                        </li>
                        <li>
                            <a href="#contact"
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0">Contacts</a>
                        </li>
                    </ul>
                </div>
            </div>
